...
const CHARACTERISTIC_UUID: uuid::Uuid = uuid::Uuid::from_u128(0xfd2bcccb0001);
...
async fn main() -> bluer::Result<()> {
    ...
    let service_uuid: uuid::Uuid = uuid::Uuid::from_str("FD2B4448-AA0F-4A15-A62F-EB0BE77A0000").unwrap();
